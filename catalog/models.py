...
CSV_HEADERS = {
    ...
    "Equivalent Subjects":      (CourseFields.equivalent_subjects, string_converter),
    "Joint Subjects":           (CourseFields.joint_subjects, string_converter),
    "Meets With Subjects":      (CourseFields.meets_with_subjects, string_converter),
